...
mover_estimater::mover_estimater(){
    sub_rgb = nh.subscribe<sensor_msgs::Image>("/usb_cam/image_raw", 1, &mover_estimater::rgbImageCallback, this);
...
void mover_estimater::rgbImageCallback(const sensor_msgs::ImageConstPtr& msg){
	...
	cv::Mat img(cv_ptr->image.rows, cv_ptr->image.cols,CV_8UC1);// CV_8UC1);
...
/*sensorInfo
void mover_estimater::moverImageCallback(const sensor_msgs::ImageConstPtr& msg){
...
int main(int argc, char **argv){
    ros::init(argc, argv, "mover_estimater");
